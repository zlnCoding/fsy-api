...
import com.fzy.api.dao.IUpOrDownloadDao;
...
@com.alibaba.dubbo.config.annotation.Service(interfaceClass = com.fsy.api.interfaces.IUpOrDownloadService.class, protocol = {"dubbo"})
