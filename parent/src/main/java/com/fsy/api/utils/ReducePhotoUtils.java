 ...
 *
 * @auth zln
 * @create 2017-12-13 10:09
 */
public class ReducePhotoUtils {
    ...
    public void resize(int w, int h) throws IOException {
        ...
        File destFile = new File(("linux".equals(Const.OSType()) ? Const.LINUX_FILE_PATH : Const.WINDOWS_FILE_PATH) + Const.OSSeparator()+"min-" + this.originalFilename);
        if (!destFile.exists()) {
